...
onMounted(() => {
  ...
  tl5.from([copyrightContext.value, socialLinkItems.value], {
    autoAlpha: 0,
    yPercent: 50,
    ease: "power.out",
    duration: 1,
...
<template>
  <div>
    <footer
      class="relative bg-black/90 text-white px-6 sm:px-18 pb-4 pt-12 overflow-hidden"
    >
      <!--Top Section-->
      ...
      <div
        ref="bottomSection"
        class="flex md:justify-between items-center flex-col sm:flex-row border-t-1 border-t-slate-600 w-full pt-4"
      >
        <!--col 1 copyright-->
        <span
          ref="copyrightContext"
          class="flex h-full text-sm text-slate-400 text-center sm:text-start"
        >
