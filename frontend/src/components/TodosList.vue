...
<template>
  <div class="w-full h-full flex items-center">
    ...
    <div
      ...
      class="w-9/10 sm:w-3/4 sm:min-w-2/5 md:w-1/2 bg-gray-400 rounded-lg mx-auto justify-items-center overflow-hidden"
    >
      <!-- main header -->
      <h3
        ref="mainHeader"
        class="text-xl font-bold text-center text-white bg-black py-2 w-full"
      >
        Todo List
      </h3>
      ...
      <div class="w-full p-2">
        <div
          ref="mainSortFrame"
          class="flex flex-col sm:flex-row gap-2 justify-between p-2 bg-gray-200 rounded-xl text-md sm:text-sm w-full"
        >
          <div>
      ...
      <div class="p-2 w-full">
        <div ref="mainTodoListParent" class="w-full overflow-y-auto h-90">
          <ul
            ref="mainTodoList"
